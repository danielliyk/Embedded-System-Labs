...
#define LSM6DSM_I2C_ADDRESS 0x6A  // Change according to your configuration
#define LSM6DSM_OUTX_L_XL 0x28     // Address of the output register for the accelerometer
...
void LSM6DSM_ReadAccelData(uint8_t *data);
  ...
  case EVT_VENDOR:
    {
      ...
      case EVT_BLUE_GATT_WRITE_PERMIT_REQ:
		{
		  printf("enter");
		  evt_gatt_prepare_write_permit_req *pr = (void*)blue_evt->data;
		  printf("write data");
		  freq = pr->data[0];
